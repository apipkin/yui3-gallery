...
Y.namespace('Xarno').Viewport = Y.Base.create('viewport', Y.Base, [], {
     ...
     */
    sync : function(){
        Y.log('sync', 'info', 'Y.Xarno.Viewport');
    ...
    mergeDefaults : function(){
        Y.log('mergeDefaults', 'info', 'Y.Xarno.Viewport');
     ...
     */
    reset : function() {
        Y.log('reset', 'info', 'Y.Xarno.Viewport');
